...
| **[ProjectFlow- project management app](https://github.com/shivraj598/ProjectFlow)** | A real-time, multi-tenant project management platform inspired by Jira, Linear & Trello| `typescript` `ReactJS` `nodeJS` `ExpressJS` `PostgreSQL` `PrismaORM` `SocketIO` `Zod` `JWT` `Zustand` `TanStack Query`|
